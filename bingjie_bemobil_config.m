...
%% General Setup
bemobil_config.study_folder = 'P:\Project_Bingjie\2HZ_StrictChanRemov\'; %(NEEDS to have a filesep at the end, sorry!) 
...
bemobil_config.bids_rb_in_sessions = [];
...
bemobil_config.rigidbody_names          =  {''};
...
bemobil_config.channels_to_remove = {'x_dir', 'y_dir', 'z_dir'};
...
%                                           abnormal. (default: 'off')
 ...
 %bemobil_config.chancorr_crit = 0.8; % default
 bemobil_config.chancorr_crit = 0.85;
 bemobil_config.chan_max_broken_time = 0.3;
 bemobil_config.chan_detect_num_iter = 10;
% bemobil_config.chan_detected_fraction_threshold = 0.5; %default
bemobil_config.chan_detected_fraction_threshold = 0.4;
...
bemobil_config.filter_lowCutoffFreqAMICA = 2.25; % 1.75 is 1.5Hz cutoff!
...
%bemobil_config.AMICA_reject_sigma_threshold = 2.8; % default 3
